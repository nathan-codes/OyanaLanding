  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--surface)" }}>
      <div className="mx-auto max-w-7xl px-4 py-8 md:py-12">
        <div className="grid min-h-[70vh] items-center gap-6 lg:gap-8 xl:gap-12 lg:[grid-template-columns:1.2fr_1fr]">
          <motion.div
          ...
          >
            ...
            <h1 className="mt-4 text-2xl font-extrabold leading-tight tracking-tight text-white md:text-3xl lg:text-4xl xl:text-5xl lg:leading-[1.08] lg:max-w-3xl text-center lg:text-left mb-3 md:mb-4">
            ...
            <p className="mt-2 md:mt-3 max-w-xl lg:max-w-2xl text-sm md:text-base lg:text-lg lg:leading-relaxed text-zinc-300 mx-auto lg:mx-0 text-center lg:text-left">
              Stop losing viewers at the 30-second mark. Start creating content
              that hooks them till the end.
            </p>

            <motion.ul
              className="mt-4 grid max-w-xl lg:max-w-2xl gap-3 md:gap-4 text-sm md:text-base text-zinc-200 mx-auto lg:mx-0"
              initial="hidden"
              animate="show"
              variants={{
                hidden: {},
            ...
            >
              {[
                ...
                >
                  <span
                    className="mt-0.5 inline-flex h-4 w-4 md:h-5 md:w-5 shrink-0 items-center justify-center rounded-full text-black text-xs"
            ...
            <form
              ...
              className="mt-6 flex max-w-sm md:max-w-md gap-2 mx-auto lg:mx-0"
            >
              <Input
                value={email}
                ...
                className="h-10 md:h-12 input placeholder:text-white/40"
              />
              <Button
                type="submit"
                disabled={isLoading}
                className="h-10 md:h-12 btn btn-primary disabled:opacity-50"
              >
          ...
          <motion.div
            className="relative h-full flex items-center lg:pl-2 xl:pl-4"
            initial={{ opacity: 0, scale: 0.98 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6, delay: 0.15, ease: "easeOut" }}
          >
            <motion.div
              className="h-[60vh] md:h-[65vh] lg:h-[70vh] w-[90vw] md:w-[45vw] lg:w-[40vw] xl:w-[42vw] mx-auto lg:ml-auto lg:[margin-right:calc((100vw-100%)/-6)]"
              animate={{ y: [0, -6, 0] }}
