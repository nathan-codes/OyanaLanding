...
export default function Hero() {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <button
                ...
                onClick={closeDemoModal}
                aria-label="Close"
                className="absolute top-3 right-3 z-10 rounded-full p-2 text-foreground/80 hover:text-foreground transition-colors cursor-pointer"
              ...
              <div
                ...
                style={{ borderTop: "1px solid var(--border-color)", backgroundColor: "var(--subtle-bg)" }}
              >
                <span className="text-sm text-muted">Oyana Demo</span>
                <button
                  type="button"
                  onClick={closeDemoModal}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,var(--glow-color),transparent_50%)]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <span className="block bg-gradient-to-r from-[var(--gradient-start)] via-[var(--gradient-end)] to-[var(--gradient-start)] bg-clip-text text-transparent glow-text">
            ...
            <motion.div
              variants={itemVariants}
              className="text-base sm:text-lg text-body leading-relaxed space-y-3"
            >
              <p>
                Deep engagement insights that show{" "}
                <span className="text-accent-text font-semibold">exactly</span> what keeps viewers
            ...
            >
              <motion.button
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] rounded-lg font-semibold text-white text-lg overflow-hidden flex items-center justify-center cursor-pointer"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <span className="relative z-10">Get Started</span>
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-[var(--primary-hover)] to-[var(--primary)]"
                  initial={{ x: "-100%" }}
                  whileHover={{ x: 0 }}
              ...
              <motion.button
                ...
                className="px-8 cursor-pointer py-4 rounded-lg font-semibold text-accent-text text-lg backdrop-blur-sm transition-all flex items-center justify-center"
                style={{
      ...
      >
        <div className="w-6 h-10 border-2 rounded-full flex justify-center" style={{ borderColor: "var(--nav-border)" }}>
